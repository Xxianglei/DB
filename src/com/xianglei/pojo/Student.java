...
public class Student {
	...
	public String getStudent_union() {
		return student_union;
	}

	public void setStudent_union(String student_union) {
	...
	public String getGraduate_student() {
		return graduate_student;
	}

	public void setGraduate_student(String graduate_student) {
