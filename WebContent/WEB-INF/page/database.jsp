...
${ sessionScope.name }
	...
	<section id="hero">
		<div class="center">
			<div class="container">
				<h1>
					<font size="7" color="antiquewhite" face="宋体">欢迎加入数据库工作室</font>
				</h1>
				<hr />
				<br />
			...
			<ul >
				...
				<li><span><img src="${ctx}/public/images/pa.png"
					...
					<p>Python语言的排名从去年开始就借助人工智能持续上升，现在它已经成为了第一名,学习他的重要性更为凸显.好玩!神奇!高薪!都是它的代名词,Python语言可以做什么?
						爬虫、web开发、大数据分析、游戏...</p>
					<p>
						爬虫应该算是一个很有趣的小东西,python拥有丰富的库,可以让你方便快速开发.现在学习python,你以后入职或考研可以学习AI,数据分析,机器学习等前沿技术.换言之
						Python=?=Future.</p></li>
			</ul>
		</div>
	</section>
	<section id="recent">
		...
		<div class="container">
			<div class="wrapper">
				<div class="focus">近期竞赛</div>
				<div class="mask">
					<div class="text">近期竞赛</div>
				</div>
			</div>
		</div>
	...
	<section id="activity">
		<div class="nospace">
			<img src="${ctx}/public/images/IMG_20180904_205848.jpg" /> <img
				src="${ctx}/public/images/1536064083968.jpeg" /> <img
				src="${ctx}/public/images/1536064091768.jpeg" /> <img
				src="${ctx}/public/images/1536064156079.jpeg" /> <img
				src="${ctx}/public/images/IMG_20180904_210150.jpg" /> <img
				src="${ctx}/public/images/IMG_20180904_210156.jpg" /> <img
				src="${ctx}/public/images/C360_2016-12-23-14-23-57-650.jpg" /> <img
				src="${ctx}/public/images/IMG20171206141719.jpg" /> <img
				src="${ctx}/public/images/IMG20171206141747.jpg" /> <img
				src="${ctx}/public/images/psb (1).jpg" /> <img
				src="${ctx}/public/images/psb (2).jpg" /> <img
				src="${ctx}/public/images/psb.jpg" />
		</div>
		<div class="center">
	...
	<section id="info">
		...
		<div class="jumbotron" id="about">
			...
			<span>
				...
				<p>
					数据库工作室成立于2006年,是一个基于数据库系统开发的基础工作室.目前可以同时容纳36人学习.我们为全校学生服务，发掘热爱软件开发的同学，以培养计算机素养与软件开发能力为目的，旨在为同学们提供学习实践的机会。我们工作室自成立以来,获取多项国家级奖项,省级奖项更是不计其数,为学校取得了极大的荣誉.同时很多工作室成员通过自己的努力成功就职于国内知名软件公司如:<a
						href="https://www.thoughtworks.com/" target="_blank"
						style="text-decoration: none;"><font color="#63B7E6">"ThoughtWorks"</font></a>、<a
						href="https://www.ifeng.com/" target="_blank"
						style="text-decoration: none;"><font color="#63B7E6">"凤凰网"</font></a>,或者拥有了自己的公司,为社会输送了大量的IT精英。我们工作室毕业的成员一次就业率达100%,平均月薪在一万以上,年薪在15万左右。目前工作室已拥有安卓开发,Javaweb开发,大数据开发,python全栈开发等方向,而新的领域正等优秀的你来开拓!
				</p>
				<p>今年工作室负责老师
					苗巍副教授的指导及支持下，我们的工作室成员在中国软件杯大学生软件开发大赛取得了辉煌的成绩.国家级奖项三项,银奖一项、铜奖两项,而在往几届竞赛中,每届竞赛只获取了一项奖项。截止目前,我们在"中国软件杯"竞赛中我们已经取得了五项国家级奖项。</p>
