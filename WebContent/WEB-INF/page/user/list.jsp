...
<body>
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a href="">首页</a> <a> <cite>用户信息</cite></a>
		</span>
		<button type="button" onclick="location.href='${ctx}/user/add'"
			class="layui-btn layui-btn-small"
			style="line-height: 1.6em; margin-top: 3px; float: innert; margin-left: 75%;">
			<i class="layui-icon"></i>增加
		</button>
		<a class="layui-btn layui-btn-small"
			style="line-height: 1.6em; margin-top: 3px; float: right"
			href="${ctx }/user/list" title="刷新"> <i class="layui-icon"
	...
	<div class="x-body">
		<div class="layui-row" style="" align="center">
			<form class="layui-form layui-col-md12 x-so" method="get"
				...
				<input type="text" name="_content" style="width: 50%;"
					placeholder="请输入查找内容" class="layui-input">
				<button class="layui-btn" lay-submit=""
					lay-filter="get_UserLikeList">
