			...
			<div class="layui-form-item layui-form-text">
				...
				<div class="layui-input-block">
					<textarea placeholder="请输入内容" id="content" name="content"
						class="layui-textarea">${job.content }</textarea>
				</div>
			</div>
				<div class="layui-inline">
				<label class="layui-form-label"> <span class="x-red">*</span>发布时间
				</label>
				<div class="layui-input-block">
					<input type="text" name="create_date" id="date1" autocomplete="off"
						class="layui-input">
				</div>
			</div>
			<p> .</p>
